...
class WeaponProcessorTest {
    ...
    public void setUp() {
        ...
        weaponProcessor.setBulletSPIS(Collections.singleton(bulletSPI));
        weaponProcessor.setValidLocations(Collections.singleton(validLocation));
    }

    @Test
    public void process_withInactivePlugin_resetsWeaponTime() {
        // Arrange
        gameData.setActivePlugin(WeaponPlugin.class.getName(), false);

        // Act
        weaponProcessor.process(gameData, world);

        // Assert
        assertEquals(0, weaponProcessor.getWeaponTime());
    }

    @Test
    public void process_withActivePluginAndWeapon_updatesWeaponDirectionAndTimer() {
        //Arrange
        gameData.setActivePlugin(WeaponPlugin.class.getName(), true);
        ...
        assertAll("weapon",
                ...
                () -> assertEquals("Weapon/src/main/resources/weapon-kopi.png", weapon.getPath())
        );
        //Arrange
        ...
        //Assert
        assertEquals("Weapon/src/main/resources/weapon.png", weapon.getPath(), "Weapon path should be changed based on moving part direction");
    }
    ...
    public void useWeapon_ShouldNotShootBullet_WhenTImeIsNotAvailable() {
        ...
        // Act
        weaponProcessor.useWeapon(player, gameData, world);
